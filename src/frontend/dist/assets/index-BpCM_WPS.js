...
function About() {
  const revealRef = useScrollReveal$4();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "section-light py-24 lg:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-4 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider w-16" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent text-xs tracking-[0.3em] uppercase font-body", children: "Our Story" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider w-16" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-black text-4xl sm:text-5xl lg:text-6xl uppercase text-foreground tracking-tight", children: [
        "Where Style Meets",
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-accent", children: "Perfection" })
      ] })
    ] }),
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg leading-relaxed mb-6 font-body", children: "Alex Hair & Skin Studio is Nagpur's premier destination for unisex beauty and grooming. We bring together world-class techniques and a passion for perfection, delivering transformative experiences for every client who walks through our doors." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-10 font-body", children: "From precision haircuts and luxurious treatments to radiant skin care and stunning bridal looks — our expert team is dedicated to making you look and feel your absolute best. We believe great style is not a luxury; it's a right." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 mb-10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-5 h-5 gold-accent shrink-0 mt-0.5" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold uppercase tracking-widest text-foreground mb-1", children: "Address" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-5 h-5 gold-accent shrink-0 mt-0.5" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold uppercase tracking-widest text-foreground mb-1", children: "Hours" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Monday – Sunday: 9:00 AM – 10:00 PM" })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 border-l-2 border-accent pl-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex", children: [
                [1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-5 h-5 fill-accent text-accent" }, i)),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-5 h-5 text-accent/30" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl font-bold gold-accent", children: "4.0 / 5" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs tracking-widest uppercase", children: "500+ Verified Reviews" })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3 h-56", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: stats.map(({ icon: Icon2, label, sub }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "border border-border hover:border-accent/60 p-5 transition-smooth group",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-7 h-7 gold-accent mb-3 group-hover:scale-110 transition-smooth" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground text-base leading-tight mb-0.5", children: label }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs leading-relaxed", children: sub })
                ]
              },
              label
            )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider w-full mt-20" })
  ] }) });
}
const services$1 = [
  "Haircut & Styling",
...
function Booking() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "booking", className: "section-light py-24 lg:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-3xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-4 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider w-16" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent text-xs tracking-[0.3em] uppercase font-body", children: "Reserve Your Slot" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider w-16" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-black text-4xl sm:text-5xl lg:text-6xl uppercase text-foreground tracking-tight", children: [
        "Book Your ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-accent", children: "Appointment" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-4 text-sm tracking-wide", children: "Fill in the form and our team will confirm your appointment." })
    ] }),
    submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-accent/50 p-12 text-center animate-fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "w-14 h-14 gold-accent mx-auto mb-5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl uppercase font-bold text-foreground mb-2", children: "Appointment Requested!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm leading-relaxed", children: [
        "Thank you,",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-semibold", children: form.name }),
        "! Our team will call you at",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-semibold", children: form.phone }),
        " ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "select",
                {
                  ...
                  children: [
                    ...
                    services$1.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: s, children: s }, s))
                  ]
                }
              )
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "label",
              {
                className: "block text-xs tracking-widest uppercase text-foreground mb-2",
                htmlFor: "b-message",
                children: "Message / Special Request"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "textarea",
...
const MAPS_URL = "https://maps.google.com/?q=Shop+No+2,+Aman+Vaili+Complex,+Jafar+Nagar+Road,+Near+Dinshaw+Factory,+Borgaon,+Bupeshnagar,+Nagpur,+Maharashtra+440013";
const MAPS_EMBED = "https://maps.google.com/maps?q=Aman+Vaili+Complex,+Jafar+Nagar+Road,+Borgaon,+Nagpur,+Maharashtra+440013&output=embed";
...
function Contact() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "section-dark py-24 lg:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-4 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider w-16" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent text-xs tracking-[0.3em] uppercase font-body", children: "Visit Us" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider w-16" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-black text-4xl sm:text-5xl lg:text-6xl uppercase text-primary-foreground tracking-tight", children: [
        "Find ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-accent", children: "Us" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-6 h-6 gold-accent shrink-0 mt-1" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/50 text-xs tracking-widest uppercase mb-2", children: "Address" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-primary-foreground leading-relaxed font-body", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-6 h-6 gold-accent shrink-0 mt-1" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/50 text-xs tracking-widest uppercase mb-2", children: "Phone" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                children: "+91 95519 99511"
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-6 h-6 gold-accent shrink-0 mt-1" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/50 text-xs tracking-widest uppercase mb-2", children: "Hours" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground font-body", children: "Monday – Sunday" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "gold-accent font-semibold", children: "9:00 AM – 10:00 PM" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/50 text-xs tracking-widest uppercase mb-4", children: "Connect With Us" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                "aria-label": "WhatsApp",
                className: "w-12 h-12 border border-primary-foreground/20 hover:border-accent flex items-center justify-center gold-accent hover:bg-accent hover:text-primary transition-smooth",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(WhatsAppIcon$1, { className: "w-5 h-5" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border border-primary-foreground/10 hover:border-accent/40 transition-smooth overflow-hidden h-80 lg:h-full min-h-[320px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "iframe",
          {
            src: MAPS_EMBED,
            width: "100%",
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "section-dark border-t border-accent/20 pt-16 pb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider w-full mb-12" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Scissors, { className: "w-5 h-5 gold-accent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-black text-xl text-primary-foreground tracking-widest uppercase", children: "Alex Hair & Skin Studio" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/50 text-sm leading-relaxed mb-6 font-body max-w-sm", children: "Best Unisex Salon in Nagpur — Where Style Meets Perfection. Committed to delivering premium beauty experiences for every client." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: [
          ...
          {
            href: "https://wa.me/919822929415",
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(WhatsAppIcon, { className: "w-4 h-4" }),
            label: "WhatsApp"
          },
          {
            href: "https://www.instagram.com/alex_salon_nagpur/",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/50 text-xs tracking-[0.25em] uppercase mb-5", children: "Quick Links" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/50 text-xs tracking-[0.25em] uppercase mb-5", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 gold-accent shrink-0 mt-0.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-primary-foreground/60 text-sm leading-relaxed font-body", children: [
              "Shop No 2, Aman Vaili Complex,",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-4 h-4 gold-accent shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider w-full mb-6" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-between gap-3 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-primary-foreground/40 text-xs tracking-widest uppercase", children: [
        "© ",
        year,
        " Alex Hair & Skin Studio. All Rights Reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-primary-foreground/30 text-xs", children: [
...
function Gallery() {
  const sectionRef = useScrollReveal$3();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      id: "gallery",
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-4 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider w-16" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent text-xs tracking-[0.3em] uppercase font-body", children: "Portfolio" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider w-16" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-black text-4xl sm:text-5xl lg:text-6xl uppercase text-primary-foreground tracking-tight", children: [
            "Our ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-accent", children: "Work" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 auto-rows-[180px]", children: galleryItems.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            "data-reveal": true,
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-primary/50 group-hover:bg-primary/30 transition-smooth z-10" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 border-2 border-transparent group-hover:border-accent/60 transition-smooth z-20" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-accent/0 group-hover:bg-accent/5 transition-smooth z-20" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-end pb-5 z-30", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground font-body font-semibold text-sm tracking-[0.15em] uppercase text-center px-4 drop-shadow", children: item.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-accent text-[10px] tracking-widest uppercase mt-1 opacity-0 group-hover:opacity-100 transition-smooth", children: item.caption })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2 right-2 w-4 h-4 border-t border-r border-accent/0 group-hover:border-accent/60 transition-smooth z-30" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-2 left-2 w-4 h-4 border-b border-l border-accent/0 group-hover:border-accent/60 transition-smooth z-30" })
            ]
          },
          item.label
        )) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mt-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            children: "See More on Instagram →"
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider w-full mt-20" })
      ] })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-primary/80" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 shadow-[inset_0_0_120px_rgba(0,0,0,0.6)]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-8 top-1/2 -translate-y-1/2 w-px h-48 gold-divider hidden xl:block opacity-40" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-8 top-1/2 -translate-y-1/2 w-px h-48 gold-divider hidden xl:block opacity-40" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 container px-6 animate-fade-in", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-px gold-divider" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent text-xs tracking-[0.35em] uppercase font-body", children: "Premium Unisex Salon · Nagpur" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-px gold-divider" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-black text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl uppercase text-primary-foreground leading-none tracking-tight mb-6", children: [
            "Alex",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-accent", children: "Hair &" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "Skin Studio"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-primary-foreground/70 text-base sm:text-lg tracking-[0.2em] uppercase mb-10 max-w-xl mx-auto", children: "Best Unisex Salon in Nagpur — Where Style Meets Perfection" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 border border-accent/40 px-4 py-2 mb-10 rounded-none", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex", children: [
              [1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-4 h-4 fill-accent text-accent" }, i)),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-4 h-4 text-accent/50" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent text-sm font-semibold tracking-widest", children: "4.0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground/50 text-sm tracking-wider", children: "|" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground/70 text-sm tracking-wider", children: "500+ Reviews" })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-40", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground text-xs tracking-widest uppercase", children: "Scroll" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-12 bg-accent animate-pulse" })
        ] })
      ]
    }
  );
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      "data-ocid": "navbar",
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "bg-primary/95 backdrop-blur-md shadow-elevated border-b border-accent/20" : "bg-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container flex items-center justify-between py-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Scissors, { className: "w-5 h-5 gold-accent transition-smooth group-hover:rotate-12" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-lg text-primary-foreground tracking-widest uppercase", children: "Alex" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1 text-xs font-body text-accent tracking-[0.2em] uppercase hidden sm:inline", children: "Hair & Skin Studio" })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden lg:flex items-center gap-8", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:hidden bg-primary border-t border-accent/20 px-6 py-8 flex flex-col gap-6", children: [
...
function Pricing() {
  const sectionRef = useScrollReveal$2();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      id: "pricing",
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-4 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider w-16" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent text-xs tracking-[0.3em] uppercase font-body", children: "Transparent Pricing" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider w-16" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-black text-4xl sm:text-5xl lg:text-6xl uppercase text-foreground tracking-tight", children: [
            "Service ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-accent", children: "Pricing" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-4 max-w-lg mx-auto text-sm tracking-wide", children: "Honest, competitive pricing with no hidden charges. All prices in INR (₹)." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6", children: [
          pricingCategories.map((cat, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              "data-reveal": true,
              ...
              className: `relative border p-6 transition-smooth ${cat.featured ? "border-accent bg-primary text-primary-foreground" : "border-border hover:border-accent/50 bg-card"}`,
              children: [
                cat.featured && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-3 left-1/2 -translate-x-1/2 bg-accent text-primary text-[10px] tracking-widest uppercase px-3 py-1 font-semibold", children: "Popular" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h3",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: cat.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "li",
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-accent/30 p-6 flex flex-col justify-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-lg font-bold uppercase tracking-wide text-foreground mb-3", children: "Custom Packages" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-5 font-body", children: "Special combo deals and seasonal offers available. Ask our team for personalized package quotes." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "tel:+919822929415",
...
const services = [
  {
    icon: Scissors,
    title: "Haircut & Styling",
    description: "Precision cuts and expert styling tailored to your face shape and lifestyle. From classic trims to bold transformations.",
    tag: "Most Popular"
  },
  {
    icon: Sparkles,
    title: "Hair Treatment",
    description: "Restore shine, strength, and health with our range of treatments — from deep conditioning to keratin smoothening.",
    tag: "Recommended"
  },
  {
    icon: Smile,
    title: "Skin Care / Facials",
    description: "Rejuvenate and glow with our curated facial treatments. Cleanups, bleach, and advanced skin therapies.",
    tag: ""
  },
  {
    icon: Heart,
    title: "Bridal Makeup",
    description: "Look radiant on your most special day. Our bridal packages are crafted for timeless elegance and lasting beauty.",
    tag: "Premium"
  },
  {
    icon: Star,
    title: "Beauty & Grooming",
    description: "Complete grooming services for men and women — waxing, threading, manicure, pedicure, and more.",
    tag: ""
  }
];
...
function Services() {
  const sectionRef = useScrollReveal$1();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      id: "services",
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-4 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider w-16" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent text-xs tracking-[0.3em] uppercase font-body", children: "What We Offer" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider w-16" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-black text-4xl sm:text-5xl lg:text-6xl uppercase text-primary-foreground tracking-tight", children: [
            "Our ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-accent", children: "Services" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6", children: [
          services.map((svc, i) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  svc.tag && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-4 right-4 text-[10px] tracking-widest uppercase border border-accent/50 text-accent px-2 py-0.5", children: svc.tag }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-10 h-10 gold-accent mb-5 group-hover:scale-110 transition-smooth" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl text-primary-foreground uppercase tracking-wide mb-3", children: svc.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/60 text-sm leading-relaxed font-body", children: svc.description }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 w-0 h-0.5 bg-accent group-hover:w-full transition-all duration-500" })
                ]
              },
              svc.title
            );
          }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-accent/40 bg-accent/5 p-8 flex flex-col items-center justify-center text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-xl text-primary-foreground mb-4 uppercase tracking-wide", children: "Ready to Transform?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/60 text-sm mb-6 font-body", children: "Book your appointment today and experience the Alex difference." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                onClick: () => {
                  var _a2;
                  return (_a2 = document.querySelector("#booking")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
                },
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-4 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider w-16" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent text-xs tracking-[0.3em] uppercase font-body", children: "Client Love" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider w-16" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-black text-4xl sm:text-5xl lg:text-6xl uppercase text-foreground tracking-tight", children: [
            "What Our Clients ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-accent", children: "Say" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center mb-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 mb-2", children: [
            [1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-8 h-8 fill-accent text-accent" }, i)),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-8 h-8 text-accent/30" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-5xl font-black gold-accent mb-1", children: "4.0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm tracking-widest uppercase", children: "500+ Verified Reviews" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6", children: testimonials.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            "data-reveal": true,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Quote, { className: "absolute top-4 right-4 w-8 h-8 text-accent/10 group-hover:text-accent/20 transition-smooth" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(StarRow, { count: t.rating }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm leading-relaxed mt-4 mb-6 font-body", children: [
                "“",
                t.text,
                "”"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-auto", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-primary flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground font-semibold text-xs tracking-widest", children: t.initials }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm", children: t.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-accent text-xs tracking-widest uppercase", children: t.service })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 w-0 h-0.5 bg-accent group-hover:w-full transition-all duration-500" })
            ]
